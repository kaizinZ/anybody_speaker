...
def extract_bert_feature(
    ...
    if language == Languages.JP:
        from nlp.japanese.bert_feature import extract_bert_feature
    elif language == Languages.EN:
        from nlp.english.bert_feature import extract_bert_feature
    elif language == Languages.ZH:
        from nlp.chinese.bert_feature import extract_bert_feature
    else:
...
def clean_text(
    ...
    if language == Languages.JP:
        from nlp.japanese.g2p import g2p
        from nlp.japanese.normalizer import normalize_text

        norm_text = normalize_text(text)
        phones, tones, word2ph = g2p(norm_text, use_jp_extra, raise_yomi_error)
    elif language == Languages.EN:
        from nlp.english.g2p import g2p
        from nlp.english.normalizer import normalize_text

        norm_text = normalize_text(text)
        phones, tones, word2ph = g2p(norm_text)
    elif language == Languages.ZH:
        from nlp.chinese.g2p import g2p
        from nlp.chinese.normalizer import normalize_text
