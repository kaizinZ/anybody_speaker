...
from constants import DEFAULT_USER_DICT_DIR
from nlp.japanese import pyopenjtalk_worker as pyopenjtalk
from nlp.japanese.user_dict.part_of_speech_data import (
    MAX_PRIORITY,
    MIN_PRIORITY,
    part_of_speech_data,
)
from nlp.japanese.user_dict.word_model import UserDictWord, WordTypes
