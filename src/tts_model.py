...
class TTSModel:
    ...
    def get_model_paths(self) -> list:
        return {"model_path": self.model_path, "config_path": self.config_path, "style_vec_path": self.style_vec_path, "device": self.device}
    
    def get_model_name(self) -> str:
        """
        モデル名を返す。
        self.model_path = 'model_assets/model_name/model_name*.safetensors'
        Returns:
            str: モデル名
        """
